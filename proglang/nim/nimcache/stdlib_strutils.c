...
/* Command for C compiler:
   gcc -c  -w  -I/usr/lib/nim -o /run/media/pascal/Acer/experiments/proglang/nim/nimcache/stdlib_strutils.o /run/media/pascal/Acer/experiments/proglang/nim/nimcache/stdlib_strutils.c */
...
STRING_LITERAL(TMP362, "invalid integer: ", 17);
...
N_NIMCALL(NI, nsuParseInt)(NimStringDesc* s) {
	...
	L = npuParseInt(s, (&result), ((NI) 0));
	{
		...
		if (!LOC3) goto LA5;
		e_103655 = 0;
		e_103655 = (Valueerror3646*) newObj((&NTI24025), sizeof(Valueerror3646));
		(*e_103655).Sup.Sup.m_type = (&NTI3646);
		LOC7 = 0;
		LOC7 = rawNewString(s->Sup.len + 17);
appendString(LOC7, ((NimStringDesc*) &TMP362));
appendString(LOC7, s);
		asgnRefNoCycle((void**) (&(*e_103655).Sup.message), LOC7);
...
N_NIMCALL(NIM_CHAR, nsuToLowerChar)(NIM_CHAR c) {
	...
	nimln(198, "strutils.nim");
	{
		...
		TMP366 = addInt(((NI) (((NU8)(c)))), ((NI) 32));
		result = ((NIM_CHAR) (((NI)chckRange((NI)(TMP366), ((NI) 0), ((NI) 255)))));
	}
	goto LA1;
	LA3: ;
	{
...
N_NIMCALL(NimStringDesc*, nsuToLowerStr)(NimStringDesc* s) {
	...
	result = mnewString(((NI)chckRange((s ? s->Sup.len : 0), ((NI) 0), ((NI) IL64(9223372036854775807)))));
	{
		...
		TMP365 = subInt((s ? s->Sup.len : 0), ((NI) 1));
		HEX3Atmp_102446 = (NI)(TMP365);
		...
		res_102449 = ((NI) 0);
		{
			...
			while (1) {
				...
				if ((NU)(i_102444) > (NU)(result->Sup.len)) raiseIndexError();
				if ((NU)(i_102444) > (NU)(s->Sup.len)) raiseIndexError();
				result->data[i_102444] = nsuToLowerChar(s->data[i_102444]);
				nimln(1895, "system.nim");
				TMP367 = addInt(res_102449, ((NI) 1));
				res_102449 = (NI)(TMP367);
			} LA3: ;
		}
	}
	popFrame();
...
{	result = 0;
	...
	m = (((a ? a->Sup.len : 0) <= (b ? b->Sup.len : 0)) ? (a ? a->Sup.len : 0) : (b ? b->Sup.len : 0));
	{
		...
		while (1) {
			...
			TMP380 = subInt(((NI) (((NU8)(LOC3)))), ((NI) (((NU8)(LOC4)))));
			result = (NI)(TMP380);
			...
			TMP381 = addInt(i, ((NI) 1));
			i = (NI)(TMP381);
		} LA2: ;
	}
	nimln(274, "strutils.nim");
	TMP382 = subInt((a ? a->Sup.len : 0), (b ? b->Sup.len : 0));
	result = (NI)(TMP382);
	}BeforeRet: ;
	popFrame();
	return result;
...
N_NIMCALL(NIM_CHAR, nsuToUpperChar)(NIM_CHAR c) {
	...
	nimln(221, "strutils.nim");
	{
		...
		TMP524 = subInt(((NI) (((NU8)(c)))), ((NI) 32));
		result = ((NIM_CHAR) (((NI)chckRange((NI)(TMP524), ((NI) 0), ((NI) 255)))));
	}
	goto LA1;
	LA3: ;
	{
...
N_NIMCALL(NimStringDesc*, nsuToUpperStr)(NimStringDesc* s) {
	...
	result = mnewString(((NI)chckRange((s ? s->Sup.len : 0), ((NI) 0), ((NI) IL64(9223372036854775807)))));
	{
		...
		TMP523 = subInt((s ? s->Sup.len : 0), ((NI) 1));
		HEX3Atmp_102510 = (NI)(TMP523);
		nimln(1874, "system.nim");
		res_102513 = ((NI) 0);
		{
			nimln(1875, "system.nim");
			while (1) {
				...
				if ((NU)(i_102508) > (NU)(result->Sup.len)) raiseIndexError();
				if ((NU)(i_102508) > (NU)(s->Sup.len)) raiseIndexError();
				result->data[i_102508] = nsuToUpperChar(s->data[i_102508]);
				nimln(1895, "system.nim");
				TMP525 = addInt(res_102513, ((NI) 1));
				res_102513 = (NI)(TMP525);
			} LA3: ;
		}
	}
	popFrame();
...
{	result = 0;
	{
		...
		i_104815 = 0;
		HEX3Atmp_104817 = 0;
		HEX3Atmp_104817 = (NI)((s ? s->Sup.len : 0) - ((NI) 1));
		res_104820 = ((NI) (start));
		{
			while (1) {
				if (!(res_104820 <= HEX3Atmp_104817)) goto LA3;
				i_104815 = res_104820;
				{
					if (!((NU8)(sub) == (NU8)(s->data[i_104815]))) goto LA6;
					result = i_104815;
					goto BeforeRet;
				}
				LA6: ;
