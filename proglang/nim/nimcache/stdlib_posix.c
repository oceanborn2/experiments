...
/* Command for C compiler:
   gcc -c  -w  -I/usr/lib/nim -o /run/media/pascal/Acer/experiments/proglang/nim/nimcache/stdlib_posix.o /run/media/pascal/Acer/experiments/proglang/nim/nimcache/stdlib_posix.c */
