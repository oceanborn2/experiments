...
/* Command for C compiler:
   gcc -c  -w  -I/usr/lib/nim -o /run/media/pascal/Acer/experiments/proglang/nim/nimcache/stdlib_etcpriv.o /run/media/pascal/Acer/experiments/proglang/nim/nimcache/stdlib_etcpriv.c */
...
static N_INLINE(NIM_BOOL, ismagicidentseparatorrune_147008)(NCSTRING cs, NI i) {
	...
	if (!(LOC2)) goto LA3;
	nimln(22, "etcpriv.nim");
	TMP642 = addInt(i, ((NI) 1));
	LOC2 = ((NU8)(cs[(NI)(TMP642)]) == (NU8)(128));
	LA3: ;
	LOC1 = LOC2;
	if (!(LOC1)) goto LA4;
	nimln(23, "etcpriv.nim");
	TMP643 = addInt(i, ((NI) 2));
	LOC1 = ((NU8)(cs[(NI)(TMP643)]) == (NU8)(147));
	LA4: ;
	result = LOC1;
	popFrame();
	return result;
