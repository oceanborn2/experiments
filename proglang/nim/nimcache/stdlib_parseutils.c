...
/* Command for C compiler:
   gcc -c  -w  -I/usr/lib/nim -o /run/media/pascal/Acer/experiments/proglang/nim/nimcache/stdlib_parseutils.o /run/media/pascal/Acer/experiments/proglang/nim/nimcache/stdlib_parseutils.c */
...
STRING_LITERAL(TMP359, "overflow", 8);
	...
	nimln(203, "parseutils.nim");
	{
		...
		(*b) = IL64(0);
		{
			...
			while (1) {
				...
				if ((NU)(i) > (NU)(s->Sup.len)) raiseIndexError();
				TMP353 = subInt(((NI) (((NU8)(s->data[i])))), ((NI) 48));
				TMP354 = subInt64((NI64)(TMP352), ((NI64) ((NI)(TMP353))));
				(*b) = (NI64)(TMP354);
				nimln(207, "parseutils.nim");
				TMP355 = addInt(i, ((NI) 1));
				i = (NI)(TMP355);
				{
		...
		TMP357 = mulInt64((*b), sign);
		(*b) = (NI64)(TMP357);
		nimln(210, "parseutils.nim");
		TMP358 = subInt(i, start);
		result = (NI)(TMP358);
	}
	LA10: ;
	popFrame();
...
N_NIMCALL(NI, npuParseBiggestInt)(NimStringDesc* s, NI64* number, NI start) {
	...
	result = rawparseint_99927(s, (&res), start);
...
N_NIMCALL(NI, npuParseInt)(NimStringDesc* s, NI* number, NI start) {
	...
	nimln(231, "parseutils.nim");
	{
		...
		e_100041 = (Overflowerror3640*) newObj((&NTI24269), sizeof(Overflowerror3640));
		(*e_100041).Sup.Sup.Sup.m_type = (&NTI3640);
		nimln(2508, "system.nim");
		LOC9 = 0;
		LOC9 = (*e_100041).Sup.Sup.message; (*e_100041).Sup.Sup.message = copyStringRC1(((NimStringDesc*) &TMP359));
		if (LOC9) nimGCunrefNoCycle(LOC9);
		nimln(233, "parseutils.nim");
		raiseException((Exception*)e_100041, "OverflowError");
	}
	goto LA1;
	LA7: ;
	{
